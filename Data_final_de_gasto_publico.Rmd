...
complete.cases(midata)

midata=midata[-c(3,26,32,33,51,56,57,60,64,69),]

midata = midata[-c(12)]

midata= na.omit(midata)

midata$pais=gsub(" ","_",midata$pais)

row.names(midata)=NULL

write.csv(midata, file="Data_final_de_gasto_publico.csv", row.names = F)
